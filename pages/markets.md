...
## What runs beneath every market
...
The full diligence picture lives on the [Security](./security.md) page, and the live transparency dashboards — multisig.kamino.fi for governance and oracles.kamino.fi for every price feed — are open to inspect at any time.
