...
**Kamino stands behind the system as your counterparty.** Kamino runs the oracle pricing on [Scope](./scope.md), the risk management on the [Vault engine](./vault-engine.md), and the white-glove integration end to end, with operational support, redemption SLAs, and clear accountability. You get a partner who operates the engine with you and answers for outcomes — the pricing, the rebalancing, the redemptions, the attestations all sit with a party you can hold responsible.
